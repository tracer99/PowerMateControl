...
- Official ARM64 Release binary alongside x64 (`PowerMateControl-<version>-windows-arm64.zip`)
- About dialog shows the binary architecture (`x64` or `ARM64`) next to the version
