...
1. Download `PowerMateControl-<version>-windows-x64.zip` or `PowerMateControl-<version>-windows-arm64.zip` from this repo’s [Releases](https://github.com/tracer99/PowerMateControl/releases) page (current: **1.4.6**). Use the ARM64 zip on native Windows on ARM.
...
├── VERSION                 # Semver source of truth (1.4.6)
├── LICENSE
├── README.md
├── scripts/
